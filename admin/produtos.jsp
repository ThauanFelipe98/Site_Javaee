...
<html lang="pt-br">
    <head>
        ...
        <title>Sua Camisa Oficial - ADMIN</title>
                                              ...
                                              <div class="modal-dialog">
                                                <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                    Ah! coé, vai excluir mesmo? <%=rs.getString("nome")%> ??
                                                  </div>
                                                  <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Não, me equivoquei</button>
                                                    <a href="produtos.jsp?funcao=excluir&id=<%=rs.getString(1)%>&imagem=<%=rs.getString("imagem")%>" class="btn btn-danger">Sim, eu quero isso</a>
                                                  </div>
                                                </div>
                                              </div>
                                            </div>
